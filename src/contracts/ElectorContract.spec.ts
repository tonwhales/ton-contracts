import { Address, ADNLAddress, TonClient } from "ton";
...
describe('ElectorContract', () => {
    ...
    //     console.warn(await contract.getPastElectionsList());
    ...
    //     const factor = 2.7;
    //     const adnl = new ADNLAddress(Buffer.from('C5C2B94529405FB07D1DDFB4C42BFB07727E7BA07006B2DB569FBF23060B9E5C', 'hex'));
    ...
    it('should parse complaints', async () => {
        ...
        let res = ElectorContract.parseComplaints(complaints.stack);
        console.warn(res);
    });
});